...
String width1="186";
%>
<jsp:useBean id="boy1" class="ch07.Case02Student" scope="request"></jsp:useBean>
<jsp:setProperty property="number" name="boy1" value="202041030102"/>
...
<hr>
<a href="case02zpy2star.jsp">case02zpy2star.jsp</a>
</body>
</html>