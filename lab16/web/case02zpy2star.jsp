...
<body>
<jsp:useBean id="boy2" class="ch07.Case02Student" scope="request"></jsp:useBean>
...
<jsp:getProperty property="number" name="boy2"/>
<br>
<jsp:getProperty property="name" name="boy2"/>
<br>
<jsp:getProperty property="width" name="boy2"/>
<br>
<hr>
